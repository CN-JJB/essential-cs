...
作者在本次 x86-64 hosted Linux build 的 direct run 中观察到 SIGSEGV-class termination；GDB 路径在作者环境中因工具缺失没有运行。你的 GDB signal/stop、位置与 backtrace 必须来自自己的实际 environment；C 不保证 SIGSEGV。
</details>
