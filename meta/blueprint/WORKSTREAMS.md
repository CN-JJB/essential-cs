...
| Build-first bounded course production | M00–M10 implementation complete after Lead review; M10–M12 Research #68/#69 and Design #71/#72 are Lead-accepted; LAB-REQ-02 remains merged; M03 GDB debt, M06 official course-fork grader NOT RUN, and OQ-BP-006 remain explicit | **ACTIVE — M11 + LAB-REQ-01 learner-facing implementation next** |
...
- Blueprint exit criteria are satisfied. Under D-027, production is build-first in bounded batches: after Research/Design and independent implementation review/verification, authoring may continue to the next ready batch without waiting for a real learner. **Issue #34 remains OPEN / DEFERRED / NON-BLOCKING** and must still use real learner evidence when resumed. Learner validation remains required before v1.0 / `RELEASED`. The M02–M04 learner packets are merged after Lead review. The accepted M00–M04 Research/Design slice is consumed. **M05–M09 Research and Design are complete/Lead-accepted and fully consumed; M05–M09 implementation is merged after Lead review, including LAB-REQ-02. M10–M12 Research #68/#69 and Design #71/#72 are Lead-accepted; M10 learner-facing implementation is now merged after Lead review. The next valid step is bounded M11 learner-facing implementation plus LAB-REQ-01, then independent Lead review before M12/EXP-03. Do not combine M11 and M12 implementation into one batch.** M03's unavailable-GDB runtime path remains explicit verification debt rather than a hidden PASS.
