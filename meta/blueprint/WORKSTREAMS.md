...
| Stage-by-stage vertical slices | Issue #25 / PR #26 Research complete; Issue #27 owns Design | **ACTIVE — Foundations/System Mechanics Design (M00–M04 + bounded P0)** |
...
- Blueprint exit criteria are satisfied. The first-slice Research Dossier is complete and Lead-accepted; continue vertically with **Issue #27 Design** before learner-facing Lesson or runnable implementation work. Do **not** translate Blueprint closure into mass Lesson writing.
