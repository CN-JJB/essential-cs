...
| Stage-by-stage vertical slices | Issue #25 / PR #26 Research complete; Issue #27 / PR #28 Design complete; Issue #29 owns first learner-facing packet | **ACTIVE — M00–M01 Lesson + Activity Pilot** |
...
- Blueprint exit criteria are satisfied. The first-slice Research and Design steps are complete and Lead-accepted. Continue with bounded learner-facing implementation through **Issue #29 (M00–M01 only)**, then review before expanding to M02–M04. Do **not** translate Design completion into mass Lesson writing.
