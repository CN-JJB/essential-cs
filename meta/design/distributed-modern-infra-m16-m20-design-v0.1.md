...
|---|---|---|---|---|
| **M16** | `L16-01` | "What is different about many machines?" | Judge, Explain, Trace | `EC-CON-010 Failure`, `EC-CON-002 Abstraction`, `EC-CON-018 Process` |
...
| **M18** | `L18-01` | "How do services delegate work?" | Judge, Explain, Trace | `EC-CON-010 Failure`, `EC-CON-009 Correctness`, `EC-CON-014 Consistency` |
...
| **M19** | `L19-03` | "How does code get to production?" | Explain, Judge, Diagnose | `EC-CON-010 Failure`, `EC-CON-005 Interface`, `EC-CON-017 Trust Boundary` |
| **M20** | `L20-01` | "How do I know the system is OK?" | Observe, Diagnose, Judge | `EC-CON-001 State`, `EC-CON-015 Concurrency`, `EC-CON-010 Failure` |
| **M20** | `L20-02` | "How do I debug a production incident?" | Diagnose, Observe, Explain | `EC-CON-010 Failure`, `EC-CON-001 State`, `EC-CON-015 Concurrency` |
